...
async def seed_admin():
    admin_email = os.environ.get("ADMIN_EMAIL", "admin-removed@example.invalid").lower().strip()
...
async def seed_test_member():
    ...
    email = os.environ.get("TEST_MEMBER_EMAIL", "member-removed@example.invalid").lower().strip()
    password = os.environ.get("TEST_MEMBER_PASSWORD", "***REMOVED***")
