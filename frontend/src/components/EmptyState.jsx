...
export const EmptyState = ({ icon: Icon, title, description, action, testid }) => {
  return (
    <div
      data-testid={testid || "empty-state"}
      className="flex flex-col items-center justify-center text-center px-8 py-20 border border-dashed border-[var(--hc-border)] bg-[var(--hc-surface)]/40"
    >
      {Icon && (
